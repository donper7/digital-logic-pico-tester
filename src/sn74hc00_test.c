...
/*
 * SN74HC00N automatic functional tester
 ...
 *
 * Pico mapping:
 *   GP2  (physical 4)  -> IC pin 1
 *   GP3  (physical 5)  -> IC pin 2
 *   GP4  (physical 6)  -> IC pin 4
 *   GP5  (physical 7)  -> IC pin 5
 *   GP6  (physical 9)  -> IC pin 9
 *   GP7  (physical 10) -> IC pin 10
 *   GP8  (physical 11) -> IC pin 12
 *   GP9  (physical 12) -> IC pin 13
 *   GP10 (physical 14) <- IC pin 3
 *   GP11 (physical 15) <- IC pin 6
 *   GP12 (physical 16) <- IC pin 8
 *   GP13 (physical 17) <- IC pin 11
 */
...
static const gate_t gates[] = {
    {"Gate 1", 2, 3, 10, 1, 2, 3},
    {"Gate 2", 4, 5, 11, 4, 5, 6},
    {"Gate 3", 6, 7, 12, 9, 10, 8},
    {"Gate 4", 8, 9, 13, 12, 13, 11},
};
...
int main(void)
{
    ...
    printf("\n==================================================\n");
    printf("SN74HC00N AUTOMATIC FUNCTIONAL TEST\n");
    printf("Quad 2-input NAND gate\n");
    printf("==================================================\n");
